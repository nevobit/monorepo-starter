...
All notable changes to the Gtalla project will be documented in this file.
...
**For detailed information about each release, see our [Release Notes](https://github.com/gtalla/gtalla/releases).**
